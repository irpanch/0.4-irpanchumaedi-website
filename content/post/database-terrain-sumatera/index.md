...
subtitle: "1,034 tile DEMNAS wilayah Sumatera"
date: 2026-05-07
lastmod: 2026-05-08
draft: false
featured: false
...
<div style="display:flex;align-items:center;gap:1rem;flex-wrap:wrap;margin-bottom:1.2rem;">
  ...
  <div>
    ...
    <div style="color:#888;font-size:0.85rem;margin-top:3px;">
      <span style="color:#64B5F6;font-weight:600;">&#11015; 106 tile</span> tersedia di OneDrive &nbsp;·&nbsp;
      <span style="color:#777;">📋 928 tile</span> via Portal BIG
    </div>
  </div>
</div>

<div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:1.2rem;">
  <a href="https://1drv.ms/f/c/22f5ef4527203c63/IgB445wlmhhxQ6lAP5QsWqN6AY1tx3UwFIgnXJWZaQhNHFg?e=4xRPDY" target="_blank"
     style="display:inline-flex;align-items:center;gap:6px;padding:8px 16px;
            background:#1565C0;color:#fff;border-radius:6px;text-decoration:none;
            font-weight:600;font-size:0.85rem;">
    📁 Buka Folder OneDrive Sumatera
  </a>
...
<div style="background:rgba(21,101,192,0.08);border-left:3px solid #1565C0;
  ...
  Folder OneDrive Sumatera akan terbuka dan nama file otomatis tersalin ke clipboard.
