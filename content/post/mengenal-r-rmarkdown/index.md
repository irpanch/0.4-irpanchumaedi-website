...
<div style="font-size: 0.82rem; color: #666; line-height: 1.6;">
  Download dari 
  <a href="https://cran.r-project.org" style="color: #90CAF9; font-weight: bold; text-decoration: none;">
    cran.r-project.org
  </a> 
  → pilih <em>Download R for Windows atau sistem operasi yang kamu pakai</em> → jalankan installer, klik Next terus sampai selesai.
</div>
</div>
</div>
...
<div style="font-size: 0.82rem; color: #666; line-height: 1.6;">
    Download dari 
    <a href="https://posit.co/download/rstudio-desktop" style="color: #80DEEA; font-weight: bold; text-decoration: none;">
        posit.co/download/rstudio-desktop
    </a> 
    → pilih versi gratis (RStudio Desktop) → install. RStudio adalah antarmuka visual untuk bekerja dengan R.
</div>
</div>
